<script>
  ...
  const folderChevronIcon = `<svg class="folder-chevron" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>`;
  ...
  function handlePageOpenNewTab(e, pageId) {
    e.stopPropagation();
    closeAllMenus();
              ...
              <div class="page-menu">
                ...
                <div class="page-menu-dropdown" class:open={openPageMenuId === page.external_id}>
                  ...
                  <button
                    ...
                    onclick={(e) => handlePageOpenNewTab(e, page.external_id)}
                  >
                    {@html openNewTabIcon}
                    Open in new tab
                  </button>
